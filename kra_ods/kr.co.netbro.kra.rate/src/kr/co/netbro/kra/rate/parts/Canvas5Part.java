...
public class Canvas5Part extends RateViewer{
	...
	public void createPartControl(final Composite parent) {
		...
		if(raceInfo != null) {
			eventBroker.post("ODS_RACE/6", raceInfo);
		}
/*
...
*/
	...
	@Inject @Optional
	public void  getEvent(@UIEventTopic("ODS_RACE/6") final RaceInfo raceInfo) {
		int type = raceInfo.getGameType();
		if(logger.isDebugEnabled()) {
			logger.debug("5part->type: "+type);
		}
