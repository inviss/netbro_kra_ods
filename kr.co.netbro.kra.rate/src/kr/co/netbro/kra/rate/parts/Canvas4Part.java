...
public class Canvas4Part extends RateViewer{
	...
	public void createPartControl(final Composite parent) {
		...
		RaceInfo raceInfo = raceInfoService.getRaceInfo(RaceType.BOK.getType());
		if(raceInfo != null) {
			eventBroker.post("ODS_RACE/5", raceInfo);
		}
/*
...
*/
	...
	@Inject @Optional
	public void  getEvent(@UIEventTopic("ODS_RACE/5") final RaceInfo raceInfo) {
		int type = raceInfo.getGameType();
		if(logger.isDebugEnabled()) {
			logger.debug("4part->type: "+type);
		}
